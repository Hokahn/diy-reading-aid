...
Sido apt install -y libdrm-tests
...
FESTER\_FOKUS\_DIOPTRIEN = 1 / 0.20
...
&#x20; quiet splash loglevel=0 logo.nologo vt.global\_cursor\_default=0 systemd.show\_status=0
...
dtparam=act\_led\_activelow=off

dtparam=pwr\_led\_trigger=none

dtparam=pwr\_led\_activelow=off
...
sudo systemctl disable bluetooth hciuart wpa\_supplicant
...
echo "powersave" | sudo tee /sys/devices/system/cpu/cpu\*/cpufreq/scaling\_governor
